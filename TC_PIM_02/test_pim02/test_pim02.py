...
class Test_OrangeHRM:
    ...
    def test_edit_employee(self, booting_function):
       ...
       self.driver.find_element(by=By.XPATH, value=locators.Web_Locators().edit_button_locator).click()
       self.driver.find_element(by=By.XPATH, value=locators.Web_Locators().employee_middle_locator).send_keys(data.Web_Data().employee_middle_name)
